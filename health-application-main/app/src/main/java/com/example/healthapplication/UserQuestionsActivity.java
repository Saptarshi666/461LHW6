...
public class UserQuestionsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button transfer_to_challenegs = findViewById(R.id.challenges);
...
//                    openHomeScreenActivity(user, account);
        ...
        transfer_to_challenegs.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent transfer = new Intent(UserQuestionsActivity.this, ChallengesActivity.class);
